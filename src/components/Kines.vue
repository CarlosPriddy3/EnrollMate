<template>
  <div class="Kines" id="kines">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Kinesiology</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          <v-toolbar dark class="blue">
            ...
            <v-toolbar-title>Kinesiology</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
            </v-toolbar-items>
          </v-toolbar>
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in kinesClasses" :key="course.id">
...
export default {
        name: 'kines',
        props: ['kinesClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
