<template>
  <div class="Ensemble" id="ensemble">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Music Ensemble</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          <v-toolbar dark class="blue">
            ...
            <v-toolbar-title>Music Ensemble</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
            </v-toolbar-items>
          </v-toolbar>
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in ensembleClasses" :key="course.id">
...
export default {
        name: 'ensemble',
        props: ['ensembleClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
