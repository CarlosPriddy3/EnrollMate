<template>
  <div class="MatSci" id="matsci">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Materials Science</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          <v-toolbar dark class="blue">
            ...
            <v-toolbar-title>Materials Science</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
            </v-toolbar-items>
          </v-toolbar>
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in matsciClasses" :key="course.id">
...
export default {
        name: 'matsci',
        props: ['matsciClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
