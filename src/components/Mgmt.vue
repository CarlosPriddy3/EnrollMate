<template>
  <div class="Mgmt" id="mgmt">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Management</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          ...
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in mgmtClasses" :key="course.id">
...
export default {
        name: 'mgmt',
        props: ['mgmtClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
