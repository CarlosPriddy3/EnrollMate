<template>
  <div class="EduCollab" id="educollab">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Education Collaborative</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          <v-toolbar dark class="blue">
            ...
            <v-toolbar-title>Education Collaborative</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
            </v-toolbar-items>
          </v-toolbar>
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in educollabClasses" :key="course.id">
...
export default {
        name: 'educollab',
        props: ['educollabClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
