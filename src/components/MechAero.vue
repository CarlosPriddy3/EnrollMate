<template>
  <div class="MechAero" id="mechaero">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Mechanical & Aerospace Engineering</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          <v-toolbar dark class="blue">
            ...
            <v-toolbar-title>Mechanical & Aerospace Engineering</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
            </v-toolbar-items>
          </v-toolbar>
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in mechaeroClasses" :key="course.id">
...
export default {
        name: 'mechaero',
        props: ['mechaeroClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
