<template>
  <div class="Music" id="music">
    <v-btn block color="gray" v-on:click.stop="dialog = true">Music</v-btn>
      ...
      <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
        <v-card>
          ...
          <v-expansion-panel expand>
            <v-expansion-panel-content :class="course.CURRENT_ENRL/course.MAX_ENRL >= .85 ? 'red lighten-4' : 'grey lighten-3'" v-for="course in musicClasses" :key="course.id">
...
export default {
        name: 'music',
        props: ['musicClasses', 'randomValues', 'convertToRange'],
        components: {
          modal,
        },
        data() {
